<section class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        <!-- Header Section -->
        <div class="text-center mb-16">
            <h2 class="text-4xl sm:text-5xl font-bold text-slate-800 mb-4">
                Visi & Misi Kami
            </h2>
            ...
            <div
                ...
                <div class="relative p-8 sm:p-10">
                    <div class="flex items-center mb-6">
                        ...
                        <h3 class="text-3xl font-bold text-slate-800 ml-4">Visi</h3>
                    </div>

                    <div class="space-y-4 text-slate-600 leading-relaxed">
                        <p>
                            Menjadi perusahaan terdepan yang memberikan solusi inovatif dan berkualitas tinggi untuk
                            menciptakan dampak positif bagi masyarakat dan lingkungan.
                        </p>
                        <p>
                            Kami berkomitmen untuk terus berkembang dan beradaptasi dengan perubahan zaman, sambil
                            mempertahankan nilai-nilai integritas dan keunggulan.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="relative p-8 sm:p-10">
                    <div class="flex items-center mb-6">
                        ...
                        <h3 class="text-3xl font-bold text-slate-800 ml-4">Misi</h3>
                    </div>

                    <ul class="space-y-4 text-slate-600">
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-purple-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                            <span>Menghadirkan produk dan layanan berkualitas tinggi yang memenuhi kebutuhan
                                pelanggan</span>
                        </li>
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-purple-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                            <span>Membangun tim yang solid dengan budaya kerja yang positif dan inklusif</span>
                        </li>
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-purple-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                            <span>Berkontribusi pada pembangunan berkelanjutan dan tanggung jawab sosial</span>
                        </li>
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-purple-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                            <span>Terus berinovasi untuk menciptakan nilai tambah bagi semua stakeholder</span>
                        </li>
                    </ul>
                </div>
            </div>

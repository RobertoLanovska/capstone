    ...
    <div id="berita-container" class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="bg-white border rounded-xl overflow-hidden shadow hover:shadow-lg transition duration-300">
        ...
        <div class="p-6">
          ...
          <h3 class="text-lg font-bold text-gray-900 mb-2">
            Prestasi siswa dalam kompetisi sains nasional
          </h3>
          <p class="text-gray-600 text-sm mb-4">
            Tim kami meraih juara pertama dalam ajang bergengsi tingkat nasional.
          </p>
      ...
      <div class="bg-white border rounded-xl overflow-hidden shadow hover:shadow-lg transition duration-300">
        ...
        <div class="p-6">
          ...
          <h3 class="text-lg font-bold text-gray-900 mb-2">
            Ekstrakurikuler yang membangun karakter siswa
          </h3>
          <p class="text-gray-600 text-sm mb-4">
            Beragam kegiatan yang memperkuat kebersamaan dan potensi siswa.
          </p>
          <a href="#" class="text-blue-600 font-semibold flex items-center hover:underline">
            Baca Selengkapnya
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
      ...
      <div class="bg-white border rounded-xl overflow-hidden shadow hover:shadow-lg transition duration-300">
        ...
        <div class="p-6">
          ...
          <h3 class="text-lg font-bold text-gray-900 mb-2">
            Inovasi siswa dalam proyek teknologi ramah lingkungan
          </h3>
          <p class="text-gray-600 text-sm mb-4">
            Siswa menciptakan ide teknologi hijau untuk masa depan yang lebih baik.
          </p>
          <a href="#" class="text-blue-600 font-semibold flex items-center hover:underline">
            Baca Selengkapnya
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"

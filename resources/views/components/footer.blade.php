...
<head>
    ...
    <title>Footer - MI Nahdlatul Ummah</title>
    ...
    <footer class="bg-green-800 text-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2 text-sm sm:text-base">
                        ...
                        <p class="text-sm sm:text-base">
                            Alamat Lengkap, Golokan, Gresik<br />
                            Kode Pos
                        </p>
                        ...
                        <div class="flex items-start space-x-2 text-sm sm:text-base">
                            ...
                            <span class="break-words">minaudlatulummah@gmail.com</span>
                        </div>
                ...
                <div class="space-y-3">
                    <h3 class="font-bold text-xl mb-3">Temukan Kami</h3>
        ...
        <!-- Copyright Section -->
        <div class="bg-green-700 py-3 sm:py-4">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <p class="text-center text-xs sm:text-sm">
                    © 2025 MI Nahdlatul Ummah - All Rights Reserved
                </p>
            </div>
        </div>
    </footer>

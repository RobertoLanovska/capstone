...
<div class="page-heading">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0">Edit Data Siswa Kelas 5</h3>
    ...
    <div class="card col-md-12 shadow-sm">
        ...
        <div class="card-body">
            <form id="formEditSiswa5"
                method="POST"
                action="{{ route('siswa_5.update', $siswa_5->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('nisn', $siswa_5->nisn) }}" required inputmode="numeric" pattern="[0-9]*"
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('telepon', $siswa_5->telepon) }}" required inputmode="numeric" pattern="[0-9]*"
                            oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    @error('telepon')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                        ...
                        value="{{ old('tanggal_masuk', $siswa_5->tanggal_masuk) }}"
                        required>
                    @error('tanggal_masuk')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <script>
                function confirmSave() {
                    Swal.fire({
                        ...
                        let form = document.getElementById('formEditSiswa5');

...
<div class="page-heading">
    ...
    <div class="card col-md-12 shadow-sm">
        ...
        <div class="card-body">
            <form id="formEditSiswa3"
                method="POST"
                action="{{ route('siswa_3.update', $siswa_3->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('nisn', $siswa_3->nisn) }}" required inputmode="numeric" pattern="[0-9]*"
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('telepon', $siswa_3->telepon) }}" required inputmode="numeric" pattern="[0-9]*"
                            oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    @error('telepon')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <script>
                function confirmSave() {
                    Swal.fire({
                        ...
                        let form = document.getElementById('formEditSiswa3');
                        ...
                        .then(() => {
                            Swal.fire({
                                ...
                                window.location.href = "{{ route('siswa_3') }}";
                            });
                        })
                        .catch(async err => {

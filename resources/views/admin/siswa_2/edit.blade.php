            ...
            <form id="formEditSiswa2"
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('alamat', $siswa_2->alamat) }}"
                        required>
                    @error('alamat')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                        ...
                        value="{{ old('tanggal_lahir', $siswa_2->tanggal_lahir) }}"
                        required>
                    @error('tanggal_lahir')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('wali_murid', $siswa_2->wali_murid) }}"
                        required>
                    @error('wali_murid')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('telepon', $siswa_2->telepon) }}"
                        required>
                    @error('telepon')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror

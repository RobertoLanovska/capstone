...
<div class="page-heading">
    ...
    <div class="card col-md-12 shadow-sm">
        ...
        <div class="card-body">
            <form id="formEditSiswa6"
                method="POST"
                action="{{ route('siswa_6.update', $siswa_6->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('nisn', $siswa_6->nisn) }}" required inputmode="numeric" pattern="[0-9]*"
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('telepon', $siswa_6->telepon) }}" required inputmode="numeric" pattern="[0-9]*"
                            oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    @error('telepon')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                        ...
                        value="{{ old('tanggal_masuk', $siswa_6->tanggal_masuk) }}"
                        required>
                    @error('tanggal_masuk')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <script>
                function confirmSave() {
                    Swal.fire({
                        ...
                        let form = document.getElementById('formEditSiswa6');
                        ...
                        .then(() => {
                            Swal.fire({
                                ...
                                window.location.href = "{{ route('siswa_6') }}";
                            });
                        })
                        .catch(async err => {
